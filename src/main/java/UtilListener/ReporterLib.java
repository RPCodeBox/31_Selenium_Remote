...
public class ReporterLib {
	...
	void generateFooterDetails(PrintWriter m_out) throws UnknownHostException {
		...
		m_out.println("<Table><Hr><I>SLK - CNA Test Automation Team</I>");
	}
	...
	protected void startHtml(PrintWriter out) {
		...
		out.println("</head>");
		out.println("<body>");
		out.println("<table cellspacing=\"0\" cellpadding=\"0\" class=\"logos\">\n" + 
				"<tr bgcolor=\"#FFFFFF\"><td style= \"text-align:center;border:1px solid white\"><h1><font color=\"purple\"><i>SLK</i></font><h1></td><td style= \"text-align:center;border:1px solid white\"><h3><font color=\"green\">CNA EPC - Automation Execution Report</font></h3></td><td style= \"text-align:center;border:1px solid white\"><h1><font color=\"red\"><i>CNA</i></font><h1></td></tr>\n" + 
				"</table>\n" + 
				"");
	}
