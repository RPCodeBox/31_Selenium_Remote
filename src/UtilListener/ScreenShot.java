...
public class ScreenShot {
	...
	public static void getScreenShot(String strScriptName) throws WebDriverException, Exception {
		String strImageBinary = ((TakesScreenshot) Utilities.WebDriverListener.getDriver())
				.getScreenshotAs(OutputType.BASE64);
		Reporter.log("ScreenShot: <a target=\"_blank\" alt=\"" + strScriptName + "\" href='data:image/png;base64,"
				+ strImageBinary + "'>ScreenShot</a>");
	}
}